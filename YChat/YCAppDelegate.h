...
#import "YCChatConnectionProtocol.h"
#import "YCConstants.h"

#define YAppDelegate ((YCAppDelegate*)[[UIApplication sharedApplication] delegate])

typedef void(^chatMessageSentResponseBlock) (NSString *response);
typedef void(^requestCompletedBlock) (id completionResponse);

@interface YCAppDelegate : UIResponder <UIApplicationDelegate, XMPPReconnectDelegate, YCChatConnectionProtocol>
{
...
@property (nonatomic, strong) id<YCChatConnectionProtocol> chatConnectionDelegate;
